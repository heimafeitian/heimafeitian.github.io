...
{RTE_IPV4(161, 142, 100, 80), RTE_IPV4(66, 9, 149, 187),
	1766, 2794, 0xd2d0a5de, 0x5c2b394a},

{RTE_IPV4(66, 9, 149, 187), RTE_IPV4(161, 142, 100, 80),
	1766, 2794, 0xd718262a, 0xc626b0ea},

{RTE_IPV4(66, 9, 149, 187), RTE_IPV4(161, 142, 100, 80),
	2794, 1766, 0xd2d0a5de, 0x5c2b394a},

{RTE_IPV4(161, 142, 100, 80), RTE_IPV4(66, 9, 149, 187),
	2794, 1766, 0x82989176, 0xafc7327f},
...
test_toeplitz_hash_calc(void)
{
	...
	/*ttl/protocol/sip/dip/sport/dport big_Endia*/
        uint8_t key[ ] = {0x00,0x11,0x42,0x09,0x95,0xBB,0xA1,0x8E,0x64,0x50,0x0A,0xEA,0x06,0xE6,0x00,0x00,};
	uint8_t key_be[RTE_DIM(key)];
	/* Convert RSS key*/
	rte_convert_rss_key((uint32_t *)&default_rss_key,
		(uint32_t *)rss_key_be, RTE_DIM(default_rss_key));

        /* Convert hashinput */
	       rte_convert_rss_key((uint32_t *)&key,
                (uint32_t *)key_be, RTE_DIM(key));
	...
	for (i = 0; i < RTE_DIM(v4_tbl); i++) {
		...
		/*Calculate hash with original key*/
                // tuple.v4.a = 0;
                tuple.v4.next_proto_id = 17;
                
	       tuple.v4.time_to_live = 0;
              //  tuple.v4.b = 0;
             //   tuple.v4.a = 0;
             /*  tuple.v4.hdr_checksum = 0; */
...
printf("**********rte_softrss RTE_THASH_V4_L3_LEN=%u i =%u  rss_l3=%08x\n",RTE_THASH_V4_L3_LEN,i,rss_l3);
printf("***********rte_softrss RTE_THASH_V4_L4_LEN =%u i =%u  rss_l3l4=%08x\n",RTE_THASH_V4_L4_LEN,i,rss_l3l4);
...
printf("################rte_softrss_be RTE_THASH_V4_L3_LEN=%u i =%u  rss_l3=%08x\n",RTE_THASH_V4_L3_LEN,i,rss_l3);
printf("################rte_softrss_be RTE_THASH_V4_L4_LEN =%u i =%u  rss_l3l4=%08x\n",RTE_THASH_V4_L4_LEN,i,rss_l3l4);
...
#if 1           
		rss_l3 = rte_softrss((uint32_t *)key_be,
                      		3, default_rss_key);
		rss_l3l4 = rte_softrss((uint32_t *)key_be,
				4, default_rss_key);
...
printf("***********rte_softrss RTE_THASH_V4_L4_LEN =%u i =%u  rss_l3l4=%08x\n",RTE_THASH_V4_L4_LEN,i,rss_l3l4);
		...
		/*Calculate hash with converted key*/
		rss_l3 = rte_softrss_be((uint32_t *)key_be,
				3, rss_key_be);
		rss_l3l4 = rte_softrss_be((uint32_t *)&key_be,
				4, rss_key_be);
